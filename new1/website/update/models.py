...
class HomePage_CourseHome(models.Model):
    ...
    img = models.ImageField(upload_to= 'courseHome', help_text="Course Field Image | width= 1000px height= 750px ", 
                                validators=[FileExtensionValidator(allowed_extensions=["jpg", "jpeg"]), Course_Home_diamension,],)
    trainerName = models.CharField(max_length = 20, help_text = "Trainer's Name here | max_length = 20 ")
    courseDuration = models.CharField(max_length = 20, help_text = "Course duration here | max_length = 20 ")
...
class HomePage_Gallery(models.Model):
    ...
    img3 = models.ImageField(upload_to= 'gallery_home', help_text="Gallery on home | width= 1000px height= 750px ", 
                                validators=[FileExtensionValidator(allowed_extensions=["jpg", "jpeg"]), Gallery_Home_diamension,],)
    img4 = models.ImageField(upload_to= 'gallery_home', help_text="Gallery on home | width= 1000px height= 750px ", 
                                validators=[FileExtensionValidator(allowed_extensions=["jpg", "jpeg"]), Gallery_Home_diamension,],)
...
def Stablish_About_diamension(value):
    img = Image.open(value)
    required_width = 2000
    required_height = 1500
    if img.width != required_width and img.height != required_height:
        raise ValidationError(f'The image diamensions must be - Width:{required_width}px, height:{required_height}px')

class AboutPage_Stablish(models.Model):

    img = models.ImageField(upload_to= 'stablishedsection', help_text="Stablished side image | width= 2000px height= 1500px ", 
                                validators=[FileExtensionValidator(allowed_extensions=["jpg", "jpeg"]), Stablish_About_diamension,],)
    title = models.CharField(max_length = 20, help_text = "Stablish detail title | max_length = 20")
    content = RichTextField()
...
class AboutPage_MissionVision(models.Model):
    ...
    img1 = models.ImageField(upload_to= 'MissionVision', help_text="Mission image | width= 520px height= 380px ", 
    ...
    content1 = RichTextField()
    img2 = models.ImageField(upload_to= 'MissionVision', help_text="Vision image | width= 520px height= 380px ", 
                                validators=[FileExtensionValidator(allowed_extensions=["jpg", "jpeg"]), MV_About_diamension,],)
...
# class AboutPage_WhyUs(models.Model):
# #     bg_img = models.ImageField(upload_to= 'MissionVision', help_text="Mission bg | width= 2000px height= 1333px ", 
#                                 validators=[FileExtensionValidator(allowed_extensions=["jpg", "jpeg"]), MV_bg_About_diamension,],)
#     img = models.ImageField(upload_to= 'WhyUs')
#     title = models.CharField(max_length = 20)                     #needed or not here
#     subtitle1 = models.CharField(max_length = 20)
#     content1 = models.CharField(max_length = 200)
#     subtitle2 = models.CharField(max_length = 20)
#     content2 = models.CharField(max_length = 200)
#     subtitle3 = models.CharField(max_length = 20)
#     content3 = models.CharField(max_length = 200)
#     subtitle4 = models.CharField(max_length = 20)
